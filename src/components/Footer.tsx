        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">+8801898899026</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-accent-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-300 text-sm">info@taifatraders.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/global-network" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
                  Global Network
                </Link>
              </li>
              <li>
                <Link href="/career" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
                  Career
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
                  FAQ
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/commodities" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
                  Essential Commodities
                </Link>
              </li>
              <li>
                <Link href="/services/edible-oils" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
                  Edible Oils
                </Link>
              </li>
              <li>
                <Link href="/services/fruits-spices" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
                  Fresh Fruits & Spices
                </Link>
              </li>
              <li>
                <Link href="/services/import-solutions" className="text-gray-300 hover:text-accent-500 transition-colors duration-300">
